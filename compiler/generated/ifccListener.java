...
public interface ifccListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link ifccParser#var_declaration}.
	 * @param ctx the parse tree
	 */
	void enterVar_declaration(ifccParser.Var_declarationContext ctx);
	/**
	 * Exit a parse tree produced by {@link ifccParser#var_declaration}.
	 * @param ctx the parse tree
	 */
	void exitVar_declaration(ifccParser.Var_declarationContext ctx);
	/**
